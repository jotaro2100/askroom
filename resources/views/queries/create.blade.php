<x-app-layout>
    <div class="py-12">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8 space-y-6">
            <h1 class="text-gray-900 dark:text-white text-center my-6 text-3xl">新しい質問を作成</h1>
            <form method="post" action="{{ route('queries.store') }}">
                ...
                <div>
                    ...
                    <x-text-area id="content" class="block mt-1 w-full min-h-max" type="text" name="content" required/>
                </div>
                <div>
